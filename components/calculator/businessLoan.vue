<template>
	<view class="jsqCon">
		...
		<view class="jsqList">
			<view>贷款金额：</view>
			<view class="jsqRight">
				<input class="jsqInput" type="number" v-model="loanMoney" placeholder="100" placeholder-style="color:#9e9e9e;" />
			</view>
		...
		<view class="jsqList">
			<view>利率：</view>
			<view class="jsqRight">
				<input class="jsqInput" type="digit" v-model="loanRate" placeholder="4.90" placeholder-style="color:#9e9e9e;" />
			</view>
		</view>
		<view class="remarks">备注：<text>商业贷款利率4.90%</text></view>
